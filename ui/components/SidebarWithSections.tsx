...
/*
 * Documentation:
 * Sidebar with sections — https://app.subframe.com/66426257c465/library?component=Sidebar+with+sections_f4047c8b-cfb4-4761-b9cf-fbcae8a9b9b5
 * Avatar — https://app.subframe.com/66426257c465/library?component=Avatar_bec25ae6-5010-4485-b46b-cf79e3943ab2
...
>(function SidebarWithSectionsRoot(
  ...
  return (
    <nav
      className={SubframeUtils.twClassNames(
        "flex h-full w-64 flex-none shrink-0 flex-col items-start border-r border-solid border-neutral-border bg-default-background",
        className
      )}
      ref={ref}
      {...otherProps}
